...
from pya.domain.model import ParsingJob
from pya.domain.ports import Clock, DomainEventPublisher, ParsingJobRepository
...
class StructuredLoggingEventPublisher(DomainEventPublisher):
    def __init__(self, logger: logging.Logger | None = None) -> None:
        self._logger = logger or logging.getLogger("pya.events")
