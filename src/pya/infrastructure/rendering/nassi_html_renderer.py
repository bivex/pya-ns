...
from pya.domain.ports import NassiDiagramRenderer
  ...
  <body>
    <div class="viewer">
      <div class="titlebar">
        ...
        <span class="titlebar-text">Pya · NSD Viewer</span>
      </div>
      <div class="toolbar">
